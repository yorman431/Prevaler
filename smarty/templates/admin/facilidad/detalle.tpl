                    ...
                    <div class="panel panel-info">
                      ...
                      <div class="row">
                                              ...
                                              <div class="col-xs-6 col-sm-4 col-md-3">
                                                <a href="#" title="{$listado[i].nombre_dir}" rel="lightbox[roadtrip]" >
                                                <img class="img-responsive" border="0" src="/imagenes/miniaturas/{$listado[i].directorio_image}"/></a><br />
                                                    {$listado[i].nombre_image|escape:"htmlall"}
                                                <a  class="btn-danger btn-xs" onclick="javascript: return confirmar('&iquest;Esta seguro que desea borrar la imagen?');" href="imagen_borrar.php?id={$listado[i].id_image}&amp;back={$id}&amp;tabla=especialidad"><i class="fa fa-times"></i></a>
                                              </div>
                                              {/section}
                                              </div>
                                            {else}
