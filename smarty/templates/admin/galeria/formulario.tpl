                        ...
                        <div class="panel-body">
                            	<div class="row">
                                    ...
                                    <form action="" method="post" name="form1" id="form1" onsubmit="MM_validateForm('nombre','','R','f_date_c','','R');return document.MM_returnValue">
                                          ...
                                          <input name="nombre" type="text" class="form-control"  placeholder="Nombre de Galeria" id="nombre" value="{$nombres}"/>
                                          </div>
                                          <div class="form-group">
                                          <label for="titulo">Título</label>
                                          <input onkeypress="javascripts: return validarletrasnum(event);" name="nombre" type="text" class="form-control" placeholder="Título de Galeria" id="nombre" value="{$nombres}"/>
                                          </div>
                                          <div class="form-group">
                                          <label for="fecha">Fecha</label>
                                          <input name="fecha" type="text" class="form-control" id="fecha" placeholder="xx/xx/xxxx"  value="{$fecha}" size="30" maxlength="50"/>
                                          </div>

                                          <div class="form-group">
                                          <label for="fecha">Descripción</label>
                                          <textarea name="descripcion" cols="70" rows="6" class="normalContenido" id="contenido"  wrap="physical">{$descripcion}</textarea>
                                          </div>
