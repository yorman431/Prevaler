                            ...
                            <div class="dataTable_wrapper">
                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-admin">
                                    ...
                                    {section name=i loop=$listado}
                                        <tr class="odd gradeX">
                                            <td>{$listado[i].enlace_con}</td>
                                            <td>{$listado[i].subenlace_con}</td>
                                            <td>{$listado[i].nombre_con|truncate:50}</td>
                                            <td>{$listado[i].fecha_con}</td>
                                            <td align="center" width="5%"><a title="Details" href="detalle.php?id={$listado[i].id_con}"><i class="fa fa-eye fa-lg"></i></a></td>
                                            <td align="center" width="5%"><a title="Edit" href="editar.php?id={$listado[i].id_con}"><i class="fa fa-edit fa-lg"></i></a></td>
                                            <td align="center" width="5%"><a title="Delete" onclick="javascript: return confirmar('Sure you want to delete this item?')" href="eliminar.php?id={$listado[i].id_con}"><i class="fa fa-trash-o fa-lg"></i></a></td>
                                        </tr>
                                    {/section}
