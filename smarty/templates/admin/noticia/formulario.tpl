                        ...
                        <div class="panel-body">
                              <div class="row">
                                    ...
                                    <form action="" method="post" name="form1" id="form1" onsubmit="MM_validateForm('nombre','','R','f_date_c','','R');return document.MM_returnValue">
                                          ...
                                          <input name="categoria" type="text" class="form-control"  placeholder="Categoría de la Noticia*" id="categoria" value="{$categoria}"/>
                                          </div>
                                          <div class="form-group">
                                          <label for="titulo">Título</label>
                                          <input name="titulo" type="text" class="form-control"  placeholder="Título de la Noticia*" id="titulo" value="{$titulo}"/>
                                          </div>
                                         <div class="form-group">
                                          <label for="subtitulo">Sub-título</label>
                                          <input name="subtitulo" type="text" class="form-control"  placeholder="Sub-título de la Noticia*" id="subtitulo" value="{$subtitulo}"/>
                                          </div>
