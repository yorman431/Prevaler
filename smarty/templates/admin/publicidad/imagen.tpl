                 ...
                 <div class="panel-body">
                     <div class="row">
                        ...
                        <form action="" method="post" enctype="multipart/form-data" name="form1" id="form1" onsubmit="MM_validateForm('nombre','','R');return document.MM_returnValue">
                         ...
                         <input name="nombre" type="text" class="form-control" id="nombre" value="{$nombres}" size="48" maxlength="100" />
                         </div>
                         <div class="form-group">
                         <label for="imagen">URL</label>
                         <input name="url" type="text" class="form-control" id="url" value="{$url}" size="48" maxlength="100" />
                         </div>
                         <div class="form-group">
