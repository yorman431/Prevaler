                                      ...
                                      <div class="panel panel-info">
                                          ...
                                          <div class="panel-body">
                                              ...
                                              <div class="col-xs-6 col-sm-4 col-md-3">
                                                ...
                                                <img class="img-responsive" border="0" src="/imagenes/miniaturas/publicidad/{$listado[i].directorio_dir}"/></a><br />
                                                    {$listado[i].nombre_dir|escape:"htmlall"}
                                                <a  class="btn-danger btn-xs" onclick="javascript: return confirmar('&iquest;Esta seguro que desea borrar la imagen?');" href="imagen_borrar.php?id={$listado[i].id_dir}&amp;back={$id}&amp;tabla=publicidad"><i class="fa fa-times"></i></a>
                                              </div>
                                              {/section}
                                              </div>
                                            {else}
