...
<form action="" method="post" enctype="multipart/form-data" name="form1" id="form1" onsubmit="MM_validateForm('nombre','','R');return document.MM_returnValue">
    ...
    <div class="form-group">
      ...
      <input name="archivo" type="file" class="form-control" id="archivo" size="33" />
    </div>
    <div class="form-group">
        <input name="envio" type="submit" class="btn btn-success" id="button" onclick="javascript: return confirmar('Are you sure you want to save?');" value="Enviar" />
