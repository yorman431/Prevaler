...
{include file='admin/layouts/head2.tpl'} {literal}
                ...
                <div class="col-lg-12 col-md-12">
                  ...
                  <form action="" method="post" name="form1" id="form1" onsubmit="MM_validateForm('nombre','','R','f_date_c','','R');return document.MM_returnValue">
                    ...
                    <div class="form-group">
                      ...
                      <input name="telefono" type="text" class="form-control" placeholder="Teléfonos de Contacto" id="telefono" value="{$telefono}"
                        required="required" />
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <input onkeypress="return validarletrasnum(event);" name="prioridad" type="number" class="form-control normalContenido" id="prioridad"
                        value="{$prioridad}" required="required" />
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <input name="ubicacion" type="text" class="form-control" placeholder="Ubicación de la Sede" id="ubicacion" value="{$ubicacion}"
                        required="required" />
                    </div>
                    ...
                    <div id="servicios">
                      ...
                      {if $servicios != ''} {foreach $servicios as $servicio}
                      <div id="servicio{$servicio.id}" class="form-group">
                        <h5>
                          <strong>{$servicio.titulo|upper} &nbsp;
                            <i class="fa fa-pencil" onclick="mostrarServicio({$servicio.id})"></i>&nbsp;&nbsp;
                            <i class="fa fa-trash" onclick="eliminarServicio({$servicio.id})"></i>
                          </strong>
                        </h5>
                      </div>
                      {/foreach} {/if}
                    ...
                    <div class="form-group">
                      ...
                      <div id="serviceButton">
                        <button type="button" class="btn btn-success" onclick="agregarServicio({$id})">
                      ...
                      <div id="especialidad">
                        ...
                        <div class="especialidad_admin">
                          <div class="nombre_especialidad">
                            <input type="checkbox" name="especialidad{$especialidad[i].id_fac}" id="especialidad{$especialidad[i].id_fac}" title="{$especialidad[i].etiqueta_fac}"
                              {if $especialidad[i].encendido eq "on"} checked="checked" {/if} /> {$especialidad[i].nombre_fac}
                          </div>
                          <div class="fotos5">
