...
<div class="row">
          ...
          {$listado[i].nombre_image|escape:"htmlall"} <a  class="btn-danger btn-xs" onclick="javascript: return confirmar('&iquest;Esta seguro que desea borrar la imagen?');" href="imagen_borrar.php?id={$listado[i].id_image}&amp;back={$id}&amp;tabla=sede"><i class="fa fa-times"></i></a>
                                        </div>
                                        {/section}
                                        </div>
                                      {else}
                                ...
                                <div class="panel panel-info">
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <div class="col-xs-6 col-sm-4 col-md-3">
                                          <img class="img-responsive" border="0" src="/imagenes/miniaturas/{$facilidad[i].directorio_image}" title="{$facilidad[i].nombre_fac}" />
                                        </div>
                                        {/section}
                                        </div>
