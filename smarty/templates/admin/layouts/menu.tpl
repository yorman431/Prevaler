    ...
    <ul class="nav navbar-top-links navbar-right">
        ...
        <li class="dropdown">
            <a class="dropdown-toggle" data-toggle="dropdown" href="#">
                <i class="fa fa-user fa-fw"></i> {$nombre} {$apellido} <i class="fa fa-caret-down"></i>
            </a>
            <ul class="dropdown-menu dropdown-user">
                <li><a href="/admin/usuario/editar.php?id={$id_usuario}"><i class="fa fa-user fa-fw"></i>Perfil de Usuario</a>
                </li>
