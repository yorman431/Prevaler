...
<div class="row">
                    ...
                    <div class="panel-body">
                        <div class="row">
                            <div class="col-lg-6 col-md-6">
                                  ...
                                  <div class="form-group">
                                  <strong>Prioridad:</strong> {$prioridad|escape:"htmlall"}
                                  </div>
                                   <div class="form-group">
          ...
          {$listado[i].nombre_image|escape:"htmlall"} <a  class="btn-danger btn-xs" onclick="javascript: return confirmar('&iquest;Esta seguro que desea borrar la imagen?');" href="imagen_borrar.php?id={$listado[i].id_image}&amp;back={$id}&amp;tabla=categoria"><i class="fa fa-times"></i></a>
                                        </div>
                                        {/section}
                                        {literal}
                                            <script>
