...
<html lang="es"><!-- InstanceBegin template="/Templates/plantilla_interno.dwt" codeOutsideHTMLIsLocked="false" -->
  <head>
    ...
    <title>{$accion} | Dartronics, INC. Packaging Automation Specialists</title>
            ...
            <div class="col-lg-12">
                <ol class="breadcrumb">
                  {section name=i loop=$breadcrumbs}
                  	{if $breadcrumbs[i].url neq "null"}
                  		<li><a href="{$breadcrumbs[i].url}?id={$breadcrumbs[i].id}">{$breadcrumbs[i].etiqueta}</a></li>
                    {else}
                    	<li class="active">{$breadcrumbs[i].etiqueta}</li>
                    {/if}
                  {/section}
                </ol>
			</div>	
        	...
        	<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
            	<div class="panel panel-default">
                	<div class="panel-heading">
            			<a title="See More >" class="enlace-fuerte" href="{$categorias[i].url}_{$categorias[i].id_cat}">{$listado[i].nombre_cat}</a>
                	</div>
                    <div class="panel-body">
                		<a href="{$categorias[i].url}_{$categorias[i].id_cat}" title="See More >" > <img alt="{$listado[i].nombre_image}" border="0" src="/imagenes/{$listado[i].directorio_image}" width="500" longdesc="{$listado[i].descripcion_pro}" class="img-responsive img-rounded" /></a>
                    </div>
                </div>
            </div>
            {/section}
