...
<html lang="es"><!-- InstanceBegin template="/Templates/plantilla_padre.dwt" codeOutsideHTMLIsLocked="false" -->
  <head>
    ...
    <meta name="title" content="{$accion} | Dartronics, INC. Packaging Automation Specialists" />
    <meta name="author" content="Dartronics, INC." />
    <meta name="subject" content="{$accion} | Dartronics, INC. Packaging Automation Specialists" />
    ...
    <title>{$accion} | Nick Auto Glass</title>
...
<nav class="navbar navbar-default navbar-fixed-top">
      ...
      <div class="carousel-inner" role="listbox">
          ...
          {section name=i loop=$banner}
            <div {if $cont eq "0"}class="item active"{else}class="item"{/if}>
                {if $banner[i].vinculo_ban neq ""}
                    <a {if $banner[i].id_ban eq "25"} target="_blank" {/if}title="{$banner[i].etiqueta_ban}" href="{$banner[i].vinculo_ban}">
                        <img alt="{$banner[i].etiqueta_ban}" src="/imagenes/banner/{$banner[i].url_ban}">
                    </a>
                {else}
                    <img alt="{$banner[i].etiqueta_ban}" src="/imagenes/banner/{$banner[i].url_ban}">
                {/if}
    ...
    <div class="container-fluid">
    	<div class="row modificado">
        {section name=i loop=$categorias}
            <div class="col-xs-4 col-sm-4 col-md-2 col-lg-2 no_padding">  
                <div>
                    <a title="{$categorias[i].etiqueta_cat}" href="{$categorias[i].url}_{$categorias[i].id_cat}">
                    <img class="img-responsive opacidad" src="/imagenes/{$categorias[i].directorio_image}" width="700" /></a>
               </div>
            </div>
        {/section}
        </div>
        	...
        	<div class="col-xs-12 no_padding">
            	<div id="Carousel2" class="carousel slide carousel-fade" data-ride="carousel">
                        ...
                        <div class="carousel-inner">
                            ...
                            {section name=i loop=$publicidad}
                            <div class="item {if $cont eq 1}active{/if}">
	...
	<!-- InstanceBeginEditable name="contenido" -->
          <div id="formulario_contacto"><img src="/imagenes/formulario_contacto.jpg" width="680" height="712" /></div>
        <!-- Fin main centro-->
<!-- InstanceEndEditable -->
    </div>
