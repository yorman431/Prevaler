...
<div class="container-fluid">
  <div class="row noticias">
    ...
    <div class="col-xs-10 col-xs-offset-1" style = "padding-bottom: 2rem">
      <h3 class="fuente_morada">
        <i class="fa fa-circle" aria-hidden="true"></i>
        {$noticia.titulo_not}
      </h3>
      <h4 class="fuente_morada">{$noticia.autor_not}</h4>
      <hr class="color_morado"> {$noticia.contenido_not}
    </div>
  ...
  <!-- Fin del Contenedor de Banner Publicitario-->
  ...
  <!-- Fin del Contenedor de Contacto-->
