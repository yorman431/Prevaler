<?php
/* Smarty version 3.1.29, created on 2018-01-19 15:07:50
  from "D:\Websites\Prevaler\smarty\templates\admin\hotel\formulario.tpl" */

if ($_smarty_tpl->smarty->ext->_validateCompiled->decodeProperties($_smarty_tpl, array (
  'has_nocache_code' => false,
  'version' => '3.1.29',
  'unifunc' => 'content_5a6209c6bcbe29_63118205',
  'file_dependency' => 
  array (
...
function content_5a6209c6bcbe29_63118205 ($_smarty_tpl) {
?>
<!DOCTYPE html>
...
" required="required"/>
                  ...
                  <div class="form-group">
                    ...
                    <input onkeypress="return validarletrasnum(event);" name="prioridad" type="number" class="form-control normalContenido" id="prioridad" value="<?php echo $_smarty_tpl->tpl_vars['prioridad']->value;?>
" required="required"/>
                  </div>
...
" class="form-group">
                            <h5><strong><?php echo mb_strtoupper($_smarty_tpl->tpl_vars['servicio']->value['titulo'], 'UTF-8');?>
 &nbsp;<i class="fa fa-pencil" onclick="mostrarServicio(<?php echo $_smarty_tpl->tpl_vars['servicio']->value['id'];?>
)"></i>&nbsp;&nbsp;<i class="fa fa-trash" onclick="eliminarServicio(<?php echo $_smarty_tpl->tpl_vars['servicio']->value['id'];?>
)"></i></strong></h5>
                          </div>
                        <?php
