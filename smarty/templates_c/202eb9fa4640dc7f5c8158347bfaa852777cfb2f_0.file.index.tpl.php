<?php
/* Smarty version 3.1.29, created on 2017-10-11 20:18:13
  from "/Applications/MAMP/htdocs/uniformese/smartylib/templates/index.tpl" */

if ($_smarty_tpl->smarty->ext->_validateCompiled->decodeProperties($_smarty_tpl, array (
  'has_nocache_code' => false,
  'version' => '3.1.29',
  'unifunc' => 'content_59de606544e997_42937075',
  'file_dependency' => 
  array (
    '202eb9fa4640dc7f5c8158347bfaa852777cfb2f' => 
    array (
      0 => '/Applications/MAMP/htdocs/uniformese/smartylib/templates/index.tpl',
      1 => 1507665165,
      2 => 'file',
    ),
  ),
...
function content_59de606544e997_42937075 ($_smarty_tpl) {
...
<div class="container-fluid">  <!-- Contenedor Principal-->
	...
	<div class="row categorias">			<!-- Contenedor de Categorias-->
...
?>
	...
	</div>						<!-- Fin del Contenedor de Categorias-->

	<div class="row productos">			<!-- Contenedor de Instagram-->

		
        
	</div>						<!-- Fin del Contenedor de Instagram-->
...
?>
	...
	</div>						<!-- Fin del Contenedor de Noticias-->

	<div class="row publicidad">			<!-- Contenedor de Publicidad-->
...
?>
	...
	</div>						<!-- Fin del Contenedor de Publicidad-->
      ...
      <div class="col-xs-10 col-xs-pull-1 col-xs-push-1" align="center">
        <div class="row bordes_verdes">
          ...
          <div class="col-xs-12 col-md-3 alineamiento2">
            <form id="footer" name="footer" method="post" action="/index.php#footer">
