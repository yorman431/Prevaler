...
?>
                            ...
                            <!-- /.table-responsive -->
                            <div class="well">
                                <h4>Información sobre el Módulo de Categorias</h4>
                                <p><strong>Imagenes Inicio: </strong>El tamaño requerido debe ser de 351 x 536 Píxeles en el caso de las primeras 4 opciones (Filipinas, Pantalones, Delantales y Gorros) ó de 757 x 367 Píxeles en el caso de las 2 ultimas opciones (Delantales Love y Otros). Además las imagenes se deben crear con el nombre "portada"</p>
                            </div>
                        </div>
                        <!-- /.panel-body -->
                    </div>
