...
$link->insertar_link();
if($link->mensaje==1){
	$mensaje="<div class='alert alert-danger'>Este enlace ya existe en el sistema</div>";	
}elseif($link->mensaje==2){
   $mensaje="<div class='alert alert-success'>El nuevo enlace fue insertado con éxito</div>";	
}
